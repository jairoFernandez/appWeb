$(document).ready(function(){
	...
	$.buscarRepetidos();
	<!-- tratamos el caso de la tecla enter -->
	...
	{	
		...
		{ 
		$( '#txtsegundorNombre' ).parent().removeClass( "has-error" );
        errores = 0; }
		return errores;
	}
	...
	$.validarPrimerApellido = function()
	{
		...
		{ 
		$( '#txtprimerApellido' ).parent().removeClass( "has-error" );
	    errores = 0; 
	    }		
		return errores;
	}
	...
	$.validarNombreCompleto = function()
	{
		...
		{ 
		$('#txtNombreCompleto').parent().removeClass("has-error");
	    errores = 0; 
	    }
		return errores;
	}
